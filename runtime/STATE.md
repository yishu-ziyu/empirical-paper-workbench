...
|---|---|---|---|---|---|
| 20260915-fm-e-build-did-narrow-1-did-be-spec | `runtime/tasks/20260915-fm-e-build-did-narrow-1-did-be-spec.md` | complete | `cursor/did-be-gate-8102` | 2026-09-15 | allow_did forces treated×period; missing hard-blocks; no PR |
| 20260915-fm-e-build-did-narrow-1-did-be-gate | `runtime/tasks/20260915-fm-e-build-did-narrow-1-did-be-gate.md` | complete | `cursor/did-be-gate-8102` | 2026-09-15 | allow_did keys minwage tokens + ck1994_long; no PR |
