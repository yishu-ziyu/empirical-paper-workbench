...
def build_method_workflows(design_spec: dict[str, Any] | None) -> list[dict[str, Any]]:
    ...
    definitions = [
        ...
        },
        {
            ...
            "method": "DID",
            "ready_label": "DID：可执行",
            "blocked_label": "DID：缺少面板标识变量（id/time）",
            "required_inputs": ["outcome", "treatment", "unit_id", "time_variable"],
            ...
            "blocker_requirements": {
                "outcome": "outcome_required",
                "treatment": "treatment_required",
                "unit_id": "panel_id_required",
                "time_variable": "time_variable_required",
            },
            "summary": "双重差分需要面板数据：个体标识(id)和时间变量(time)。",
        },
        {
            "id": "iv",
            "method": "IV",
