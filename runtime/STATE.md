...
|---|---|---|---|---|---|
| 20260907-m1-expectation-criterion-p0 | `runtime/tasks/20260907-m1-expectation-criterion-p0.md` | complete | `review/generic-research-spine-hardening` / PR #31 | 2026-09-07 | C29–C37 ACCEPT；push PR #31；不 merge |
