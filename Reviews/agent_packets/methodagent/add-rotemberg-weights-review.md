# Evidence Packet: add_rotemberg_weights_review
...
- Action: 在 share/shock 组件可用后计算或审阅 Rotemberg weights。
- Reason: 在 share/shock 组件可用后计算或审阅 Rotemberg weights。
...
- Draft packet path: `Reviews/agent_packets/methodagent/add-rotemberg-weights-review.md`
