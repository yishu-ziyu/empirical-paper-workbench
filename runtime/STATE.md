...
|---|---|---|---|---|---|
| 20260907-m1-expectation-criterion-p0 | `runtime/tasks/20260907-m1-expectation-criterion-p0.md` | active | `review/generic-research-spine-hardening` / PR #31 | 2026-09-07 | 只修 M1 P0；push PR #31；不 merge |
