# Evidence Packet: add_weak_iv_robust_interval_or_caveat
...
- Action: 补充 AR/CLR 等弱工具稳健区间；若当前 exactly identified 设定无法给出，则在主结论中加入因果表述 caveat。
- Reason: 补充 AR/CLR 等弱工具稳健区间；若当前 exactly identified 设定无法给出，则在主结论中加入因果表述 caveat。
...
- Draft packet path: `Reviews/agent_packets/methodagent/add-weak-iv-robust-interval-or-caveat.md`
