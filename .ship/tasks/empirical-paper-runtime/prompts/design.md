...
接收用户项目文件夹，系统性读取全部代码，理解架构与数据流，探索与当前 empirical paper runtime 的融合可能性
---
...
- Write `.ship/tasks/empirical-paper-runtime/plan/problem.md`:
...
- Write `.ship/tasks/empirical-paper-runtime/plan/scope.md`:
  - In scope: <list>
...
- Include these in `.ship/tasks/empirical-paper-runtime/plan/spec.md` (merged with Phase 3 output)
...
task_id: empirical-paper-runtime
Artifacts: .ship/tasks/empirical-paper-runtime/plan/
Raw input: .ship/tasks/empirical-paper-runtime/input/requirement.md
Run state: .ship/tasks/empirical-paper-runtime/control/run_state.yaml
Branch: ship/empirical-paper-runtime
HEAD: 60efb23a1a283809dd3a3910493821f4f9c001b4
Scope mode: full
...
them under .ship/tasks/empirical-paper-runtime/control/. Choose the schema yourself and keep
