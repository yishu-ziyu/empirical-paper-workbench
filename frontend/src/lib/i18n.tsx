...
const zh = {
  ...
  'guide.samplesKicker': '工作台',
  'guide.samplesTitle': '主张、星级、主表，然后才是正文',
  'guide.samplesBody': '提交研究方向之后先出现估计读数。没有主表，不能写结果章。',
...
const en: typeof zh = {
  ...
  'guide.badge': 'Empirical research desk',
  ...
  'guide.samplesKicker': 'The desk',
  'guide.samplesTitle': 'Claim, stars, and the main table — then prose',
  'guide.samplesBody': 'After you submit a research direction, the estimate appears first. No main table, no results chapter.',
