# Evidence Packet: recover_bartik_share_shock_components
...
- Action: 恢复或构造 Bartik share/shock 原始组件，避免把聚合 bartik_iv 当作完整 shift-share 诊断。
- Reason: 恢复或构造 Bartik share/shock 原始组件，避免把聚合 bartik_iv 当作完整 shift-share 诊断。
...
- Draft packet path: `Reviews/agent_packets/dataagent/recover-bartik-share-shock-components.md`
