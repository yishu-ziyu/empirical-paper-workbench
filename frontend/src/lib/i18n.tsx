...
const zh = {
  ...
  'app.step1Title': '上传数据',
  'app.step1Desc': '上传数据文件开始分析，支持任何表格型经济学数据集。',
  ...
  'app.welcomeHint': '支持格式：CSV · Stata · Excel · 您的数据仅用于本次会话，不会永久存储。',
  'app.exportDoc': '导出论文',
  'app.exportCode': '导出代码',
  ...
  'app.uploadToExplore': '先上传数据，再做数据探索。',
  'app.needSession': '请先上传数据。',
  ...
  'guide.lead': '上传数据，填写研究问题和方法。先看到估计结果，再一章一章写。',
  'guide.sub': '提交后不会生成整篇。没有主表，不能写结果章。',
  'guide.step1Title': '上传数据',
  'guide.step1Body': 'CSV、Stata、Excel 都可以，截面或面板。没有文件就用示例数据。',
  ...
  'direction.hintMissing': '不填将由系统自行推断',
  'direction.needQuestionVarMethod': '还差：研究问题、因变量、自变量或方法',
  'directionChat.placeholder': '说说你想研究什么——哪怕很模糊，比如"感觉数字经济影响了工资"',
  'directionChat.placeholderNext': '继续补充或回答上面的问题',
  'directionChat.send': '发送',
  'directionChat.thinking': '想问题中…',
  'directionChat.error': '这条线断了，再说一遍试试。',
  'directionChat.cardTitle': '研究设定（在对话中逐渐清晰）',
  'directionChat.ready': '已可估计',
  'directionChat.skipToForm': '跳过对话，直接填设定',
  'directionChat.backToChat': '回到对话',
  'directionChat.expandEdit': '展开编辑',
  'directionChat.collapse': '收起',
  'directionChat.pending': '待定',
  'directionChat.start': '按这个设定开始估计 →',
  'directionChat.needDataToStart': '把数据给我，马上开工（下方上传 / 示例）',
  'directionChat.needData': '设定齐了。把数据给我（右下角上传或用示例数据），马上开工。',
  'home.heading': '用数据写实证论文',
  'home.sub': '说清你想研究什么。先看见估计结果，再一章一章写。',
  'home.dataRow': '已经有数据？',
  'home.upload': '上传数据',
  'home.sample': '用示例数据',
  'versionHistory.title': '版本历史（选择即回滚）',
  'versionHistory.empty': '这一章还没有历史版本',
  'badge.approved': '已批准',
  'badge.pending': '待批准',
  'badge.edited': '已编辑',
  'badge.rolledBack': '已回滚',
  'direction.pickFromColumns': '可从数据列选择',
  'app.exportLockedHint': '完成主结果并写出章节后解锁',
...
const en: typeof zh = {
  ...
  'app.hint': 'Upload a data file to start',
  'app.logout': 'Logout',
  'app.login': 'Sign in',
  ...
  'app.step1Desc': 'Upload a data file to get started. We accept any tabular economics dataset.',
  ...
  'app.welcomeHint': 'Supported formats: CSV · Stata · Excel · Your data stays private and is not stored permanently.',
  ...
  'app.uploadToExplore': 'Upload your data, then explore it.',
  'app.needSession': 'Upload data first.',
  ...
  'guide.lead': 'Upload your data, enter the research question and method. See the estimate first, then write chapter by chapter.',
  'guide.sub': 'Submitting does not generate the whole paper. No main table, no results chapter.',
  'guide.step1Title': 'Upload your data',
  'guide.step1Body': 'CSV, Stata, or Excel — cross-section or panel. Use the sample file if you do not have one yet.',
  ...
  'direction.hintMissing': 'Leave blank to let the system infer',
  'direction.needQuestionVarMethod': 'Missing: question, outcome, treatment, or method',
  'directionChat.placeholder': 'Say what you want to study — even vague, e.g. "digital economy seems to affect wages"',
  'directionChat.placeholderNext': 'Add more, or answer the question above',
  'directionChat.send': 'Send',
  'directionChat.thinking': 'Thinking…',
  'directionChat.error': 'That thread broke — try saying it again.',
  'directionChat.cardTitle': 'Research design (clarifying through conversation)',
  'directionChat.ready': 'Estimable',
  'directionChat.skipToForm': 'Skip chat, fill the card directly',
  'directionChat.backToChat': 'Back to chat',
  'directionChat.expandEdit': 'Expand to edit',
  'directionChat.collapse': 'Collapse',
  'directionChat.pending': 'TBD',
  'directionChat.start': 'Start estimating with this design →',
  'directionChat.needDataToStart': 'Send me the data and we start now (upload / sample below)',
  'directionChat.needData': 'Design is set. Send me the data (upload or sample below) and we start.',
  'home.heading': 'Write an empirical paper from your data',
  'home.sub': 'Describe what you want to study. See the estimate first, then write chapter by chapter.',
  'home.dataRow': 'Already have data?',
  'home.upload': 'Upload data',
  'home.sample': 'Try sample data',
  'versionHistory.title': 'Version history (click to roll back)',
  'versionHistory.empty': 'No versions for this chapter yet',
  'badge.approved': 'Approved',
  'badge.pending': 'Pending review',
  'badge.edited': 'Edited',
  'badge.rolledBack': 'Rolled back',
  'direction.pickFromColumns': 'Pick from data columns',
  'app.exportLockedHint': 'Unlocks after the main result and a written chapter',
  ...
  'editor.emptyHint': 'Upload a data file to start',
  ...
  'journey.step3.desc': 'Data exists before identification.',
