...
const zh = {
  ...
  'workbench.formatBody': '写出章节后即可导出完整 docx，以及 Stata/R。',
...
const en: typeof zh = {
  ...
  'guide.step4Body': 'When you are done, export a complete docx, plus Stata/R.',
  ...
  'guide.nowExport': 'Next: refine, then export a complete docx.',
  ...
  'workbench.formatBody': 'After a chapter is written, export a complete docx, plus Stata/R.',
