...
- 状态：needs_human_level3_quality_review
- 门禁：red
- 可进入 Level 3 人工审阅：False
- 正式论文写回：否
...
## 后续任务
- `mark_candidate_references_for_human_review`
- `human_review_level3_package_artifacts`
