...
|---|---|---|---|---|---|
| 20260907-localized-first-study | `runtime/tasks/20260907-localized-first-study.md` | active | `review/localized-first-study` / main `87c5e5b` | 2026-09-07 | implementer 已交；待 validator；独立 PR；不 merge |
