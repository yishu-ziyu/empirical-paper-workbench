# Evidence Packet: fix_submission_metadata
...
- Action: 补齐摘要、JEL、关键词和数据可得性说明，使草稿进入目标投稿规范。
...
- Draft packet path: `Reviews/agent_packets/manuscriptagent/fix-submission-metadata.md`
