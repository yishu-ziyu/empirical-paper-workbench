...
|---|---|---|---|---|---|
| FM-E-BUILD-BRYCE-1 / NORMS-BE | `runtime/tasks/20260915-fm-e-build-norms-be-1.md` | active | `feat/fm-e-build-norms-be-1` from `4546e4de` | 2026-09-15 | yaml + loader + propose/write hooks; run tests; no PR |
