...
class ApiContractV2Tests(unittest.TestCase):
    ...
    def test_bdd_3_datasets_empty_state_is_explicitly_mocked(self) -> None:
        """行为 3：Phase A 无数据集时返回可解释空状态，而不是未实现。"""
        ...
        self.assert_required_keys(body["empty_state"], {"title", "description", "next_action"})
