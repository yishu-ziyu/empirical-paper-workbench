...
|---|---|---|---|---|---|
| 20260915-fm-e-build-did-narrow-1-did-be-gate | `runtime/tasks/20260915-fm-e-build-did-narrow-1-did-be-gate.md` | active | `cursor/did-be-gate-8102` | 2026-09-15 | DID-BE-gate: title/catalog → allow_did; push branch only |
