...
- 2026-09-24：复现脚本与复现包已落地，覆盖研究台账的设定运行和固定分派的主估计，见 [验收契约](../../acceptance/replication-script.md)。导出对话框第一项改为“实际运行的代码”。尚未做：Notebook 界面、`used_by` 反查、估计 Agent 路径的执行核实、稳健性检验和清洗步骤的计算记录。
