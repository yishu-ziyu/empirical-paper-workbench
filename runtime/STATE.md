...
|---|---|---|---|---|---|
| FM-E-BUILD-DID-BE-SPEC re-cut | `runtime/tasks/20260915-fm-e-build-did-spec-recut.md` | active | `feat/fm-e-build-did-spec-recut-1` from `9f154dda` | 2026-09-15 | hard-block missing treat×period on confirmed did; no PR |
