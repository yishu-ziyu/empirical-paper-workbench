"""Attach + confirm-attach (DC-BE-attach).
...
Does not rank catalog entries, lock ``session.design``, or boot Card.
"""
...
def attach_gate_fields(attached: bool) -> dict[str, bool]:
    """Write both snapshot and later-slice spellings of the product gate."""
