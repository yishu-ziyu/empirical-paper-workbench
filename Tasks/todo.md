...
- [ ] 下一步 P7-BC：实现 manifested routed next gate run preflight（只消费 P7-BB gate result 和 entry manifest；默认因 P7-BB blocked 而 blocked，ready 时只预检将要运行的 routed next gate command，不真正运行下一关）。
