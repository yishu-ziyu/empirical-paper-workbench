...
|---|---|---|---|---|---|
| FM-E-BUILD-REAL-FETCH-1 / FD-BE-fetch-card | `runtime/tasks/20260915-fd-be-fetch-card.md` | active | `feat/fm-e-build-fd-be-fetch-card-1` from `8303340` | 2026-09-15 | Card zip fetch + tests; no PR |
