...
|---|---|---|---|---|---|
| FM-E-BUILD-INFER-MERGE-1 | `runtime/tasks/20260915-fm-e-build-infer-merge-1.md` | active | `feat/fm-e-build-infer-merge-1` | 2026-09-15 | serial merge of G0+propose+confirm+dc-suggest+did-gate; no PR |
